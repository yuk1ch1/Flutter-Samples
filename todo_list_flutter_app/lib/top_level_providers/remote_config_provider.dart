...
/// Providerを使ってキャッシュしておくことで、remoteConfigProviderを通じて初期設定を済ませたRemoteConfigのインスタンスを取得できる
final remoteConfigProvider = Provider<FirebaseRemoteConfig>((ref) {
  final rc = FirebaseRemoteConfig.instance;

  // 本番環境ではFetch間隔を12分に設定、開発環境では0
  final flavor = ref.watch(flavorProvider);
  final interval = flavor == Flavor.production ? const Duration(minutes: 12) : Duration.zero;
